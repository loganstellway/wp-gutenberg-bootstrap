 ...
 */
const EmbedResponsiveEdit = ( { attributes, setAttributes, className } ) => {
    // Attributes
    const { bgUrl, bgId, bgAttachment, addBgColor, bgColor, addMaskColor, maskColor, bgPosition, addTextColor, textColor, textAlign, ratio, customX, customY, grow, verticalAlign } = attributes;
    ...
    return (
        <Fragment>
            <InspectorControls>
                <PanelBody className="editor-panel-embed-settings" title={ getPanelTitle( 'embed', __( 'Embed' ) ) }>
                    <ToggleControl
